...
if (!function_exists('add_styles')) {
	function add_styles() {
		...
		wp_enqueue_style( 'main', get_template_directory_uri().'/style.css' );
     	...
     	wp_enqueue_style( 'icon', 'https://use.fontawesome.com/releases/v5.8.1/css/all.css');
		wp_enqueue_style( 'user63447817', get_template_directory_uri().'/css/style-post-user63447817.css');
		wp_enqueue_style( 'header-user63447817', get_template_directory_uri().'/css/header-post-user63447817.css');
		wp_enqueue_style( 'archive-user63447817', get_template_directory_uri().'/css/archive-post-user63447817.css');
		wp_enqueue_style( 'single-user63447817', get_template_directory_uri().'/css/single-post-user63447817.css');
		wp_enqueue_style( 'loop-user63447817', get_template_directory_uri().'/css/loop-post-user63447817.css');
	}
}
...
if (!function_exists('content_class_by_sidebar')) {
	function content_class_by_sidebar() {
		if (is_active_sidebar( 'sidebar' )) { 
			echo 'col-sm-12'; // changed to col-sm-9
		} else { 
			echo 'col-sm-12';
		}
	}
